...
<html lang="en">
  ...
  <head>
    ...
    <title>Signin Snowra Builders</title>



    <!-- Bootstrap core CSS -->

    <link href="assets/css/bootstarp.min.v3.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" role="form" method="post">
        ...
        <input type="text" class="form-control" placeholder="User Name" id="txtUser" name="txtUser" required autofocus>
